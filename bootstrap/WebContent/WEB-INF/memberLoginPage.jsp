            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <!-- to get an API token!-->
                        <form id="contactForm" method="post" action="memberLogin.do">
                            <!-- 회원 아이디 -->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="name" type="text"  name="id" placeholder="Enter your name..."/>
                                <label for="name">회원 아이디</label>
                                <div class="invalid-feedback" data-sb-feedback="name:required">A name is required.</div>
                            </div>
                            <!-- 회원 비밀번호-->
                             <div class="form-floating mb-3">
                                <input class="form-control" id="name" type="password" name="pass" placeholder="Enter your name..."/>
                                <label for="name">회원 비밀번호</label>
                                <div class="invalid-feedback" data-sb-feedback="name:required">A name is required.</div>
                            </div>
